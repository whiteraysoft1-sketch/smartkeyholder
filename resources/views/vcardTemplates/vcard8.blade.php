...
<head>
    ...
    <title>Tech Innovator - Uganda</title>
    ...
    <style>
        ...
        .gallery-caption {
            ...
            left: 0;
            right: 0;
            background: linear-gradient(transparent, rgba(16,185,129,0.7));
            color: #fff;
            font-size: 0.85rem;
...
<body>
    <div class="glass-card">
        ...
        <div class="relative w-full h-48 bg-cover bg-center rounded-t-2xl" style="background-image: url('{{ $profile->background_image_url }}');">
            ...
            <div class="absolute inset-0 bg-gradient-to-br from-teal-600/40 via-teal-400/30 to-emerald-500/40 rounded-t-2xl"></div>
            
            <!-- Profile Image Overlapping -->
            <div class="absolute -bottom-12 left-6">
                <img src="{{ $profile->full_profile_image_url ?? 'https://via.placeholder.com/90x90/0f766e/ffffff?text=' . substr($user->name ?? 'TI', 0, 2) }}" alt="Avatar" class="avatar border-4 border-white">
            </div>
            
        </div>
        <!-- Spacer and Profile Info -->
        <div class="pt-16 pb-6 px-6">
            <div class="glass-title">{{ $profile->display_name ?? $user->name ?? 'Tech Innovator' }}</div>
            <div class="glass-role">{{ $profile->profession ?? 'Tech Entrepreneur' }}</div>
        ...
        <div class="glass-header">
            <img src="{{ $profile->full_profile_image_url ?? 'https://via.placeholder.com/90x90/0f766e/ffffff?text=' . substr($user->name ?? 'TI', 0, 2) }}" alt="Avatar" class="avatar">
        ...
        <div class="glass-bio">
            {{ $profile->bio ?? 'Driving digital transformation in Uganda with innovative tech solutions.' }}
        </div>
    ...
    <script>
        function saveContact() {
            const name = "{{ $profile->display_name ?? $user->name ?? 'Tech Innovator' }}";
