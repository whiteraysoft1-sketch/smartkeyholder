            ...
            <div class="px-3 sm:px-6 py-3 sm:py-4">
                ...
                <div class="space-y-3">
                    @foreach($socialLinks as $link)
                        <a href="{{ $link->url }}" target="_blank" class="social-link-card media-item rounded-xl p-4 flex items-center fade-in hover:scale-105 transition-all duration-300">
                            <div class="w-12 h-12 rounded-full flex items-center justify-center text-white mr-4 shadow-lg
                                @switch($link->platform)
                                    ...
                                    @case('tiktok') bg-gradient-to-r from-black to-gray-700 @break
                                ...
                                @switch($link->platform)
                                    ...
                                    @case('tiktok')<i class="fab fa-tiktok text-lg"></i>@break
                                    @default<i class="fas fa-link text-lg"></i>@break
                                @endswitch
                            </div>
                            <div class="flex-1">
                                <div class="font-bold text-white capitalize">{{ $link->platform }}</div>
                                <div class="text-sm text-yellow-200">Follow us on {{ ucfirst($link->platform) }}</div>
                            </div>
