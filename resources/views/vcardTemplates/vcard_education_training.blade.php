            ...
            <div class="px-6 py-4">
                ...
                <div class="space-y-3">
                    ...
                    <div class="contact-item rounded-lg p-3 flex items-center fade-in">
                        ...
                        <a href="mailto:{{ $profile->business_email }}" class="bg-blue-500 text-white px-3 py-1 rounded-lg text-sm hover:bg-blue-600 transition-colors">
                            Email
                        </a>
                    </div>
                    @endif
                        ...
                        <a href="{{ $link->url }}" target="_blank" class="social-link-card contact-item rounded-xl p-4 flex items-center fade-in hover:scale-105 transition-all duration-300">
                            <div class="w-12 h-12 rounded-full flex items-center justify-center text-white mr-4 shadow-lg
                                @switch($link->platform)
                                    ...
                                    @case('discord') bg-gradient-to-r from-indigo-500 to-indigo-700 @break
                                    @case('zoom') bg-gradient-to-r from-blue-400 to-blue-600 @break
                                ...
                                @switch($link->platform)
                                    ...
                                    @case('discord')<i class="fab fa-discord text-lg"></i>@break
                                    @case('zoom')<i class="fas fa-video text-lg"></i>@break
