            ...
            <div class="px-6 py-4">
                ...
                <div class="space-y-3">
                    ...
                    <div class="contact-item rounded-lg p-3 flex items-center fade-in">
                        ...
                        <a href="tel:{{ $profile->business_phone }}" class="bg-blue-600 text-white px-3 py-1 rounded-lg text-sm hover:bg-blue-700 transition-colors">
                            Call
                        </a>
                    </div>
                    @endif
                    ...
                    <div class="contact-item rounded-lg p-3 flex items-center fade-in">
                        ...
                        <a href="mailto:{{ $profile->business_email }}" class="bg-cyan-600 text-white px-3 py-1 rounded-lg text-sm hover:bg-cyan-700 transition-colors">
                            Email
                        </a>
                    </div>
                    @endif
