    ...
    <aside id="sidebar" class="cyber-sidebar w-64 min-h-screen flex-shrink-0 fixed left-0 top-0 z-30">
        <div class="p-6">
            ...
            <nav class="space-y-2">
                ...
                <a href="{{ route('admin.qr-codes.export') }}" class="flex items-center px-4 py-3 text-gray-400 hover:text-white hover:bg-slate-700/50 rounded-lg transition">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"/>
                    </svg>
                    Export QR Codes
                </a>
                <a href="{{ route('admin.logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="flex items-center px-4 py-3 text-gray-400 hover:text-white hover:bg-slate-700/50 rounded-lg transition mt-8">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
        ...
        <header class="bg-white shadow-sm sticky top-0 z-20">
            <div class="px-6 py-4 flex items-center justify-between">
                ...
                <div class="flex-1 max-w-xl">
                    <div class="relative">
                        <input type="text" placeholder="Search..." class="w-full pl-10 pr-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                ...
                <div class="space-y-4">
                    @foreach($recentSubscriptions as $subscription)
                        <div class="flex items-start justify-between py-3 border-b border-gray-100 last:border-0">
                            <div class="flex-1">
                                <div class="font-semibold text-gray-900 text-base">{{ $subscription->user->name }}</div>
